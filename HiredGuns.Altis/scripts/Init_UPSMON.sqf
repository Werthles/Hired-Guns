...
UPSMON_ambushdist = 300; // decreased from 100 to 75, so max distance is 150 m
...
UPSMON_closeenough = 200;  // ToDo investigate effect of decrease of this value to e.g. 50 // 300
